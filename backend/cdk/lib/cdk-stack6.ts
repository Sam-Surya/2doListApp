...
export class CdkStack6 extends Stack {
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    // Defines AWS Lambda
    const resetLambda = new lambda.Function(this, "ResetLambdaSam", {
     
      runtime: lambda.Runtime.NODEJS_18_X, 
      handler: 'reset-pass-lambda.handler', 
    ...
    // Create an API Gateway
      const api = new apigateway.RestApi(this, '2doListResetpass_Api', {
