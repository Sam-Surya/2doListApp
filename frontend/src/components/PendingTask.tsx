...
export default function PendingTask() {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        if (sortType === 'TaskID') {
          const response = await axios.get('https://hfxbnbzyg1.execute-api.us-east-1.amazonaws.com/prod/fetchpendingtask', {
  ...
  return (
    <div>
      ...
      <div> <h1 className='TaskType'>Tasks in Progress </h1></div>
